...
import com.example.naroro.electric_heater.BuildConfig;
import com.example.naroro.electric_heater.R;

public class TempCircleProgress extends View {

    private static final String TAG = TempCircleProgress.class.getSimpleName();
    ...
    public TempCircleProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
